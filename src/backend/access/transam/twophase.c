...
EndPrepare(GlobalTransaction gxact)
{
	 ...
	 */
	SyncRepWaitForLSN(gxact->prepare_end_lsn, InvalidTransactionId, true /*prepared?*/, false /*commit*/);
								...
								const char *gid)
{
	 ...
	 */
	SyncRepWaitForLSN(recptr, InvalidTransactionId, true /*prepared?*/, true /*commit?*/);
}
							   ...
							   const char *gid)
{
	 ...
	 * in the procarray and continue to hold locks.
	 */
	SyncRepWaitForLSN(recptr, InvalidTransactionId, true /*prepared?*/, false /*commit?*/);
}
